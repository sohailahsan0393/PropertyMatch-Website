    ...
    <div class="sidebar" id="sidebar">
        ...
        <div>
            ...
            <div class="nav" style="padding-top: 5% !important;">
                ...
                <x-nav-link href="/admin-active-properties" :active="request()->is('admin-active-properties')">
                    <img src="{{asset('img/active.png')}}" alt="Logo" style="width:25px;">
                    <span>Active Properties</span>
                </x-nav-link>

                <x-nav-link href="/admin-pending-properties" :active="request()->is('admin-pending-properties')">
                    <img src="{{asset('img/pending.png')}}" alt="Logo" style="width:25px;">
                    <span>Pending Properties</span>
                </x-nav-link>

                <x-nav-link href="/manage-properties" :active="request()->is('manage-properties')">
                    <img src="{{asset('img/manage.png')}}" alt="Logo" style="width:25px;">
                    <span>Manage Properties</span>
                </x-nav-link>

                <x-nav-link href="/contact-persons" :active="request()->is('contact-persons')">
                    <img src="{{asset('img/contact.png')}}" alt="Logo" style="width:25px;">
                    <span>Contact persons</span>
                </x-nav-link>

                <x-nav-link href="/users" :active="request()->is('users')">
                    <img src="{{asset('img/users.png')}}" alt="Logo" style="width:25px;">
                    <span>All users</span>
                </x-nav-link>

                <x-nav-link href="admin-profile" :active="request()->is('admin-profile')">
